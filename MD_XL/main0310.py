from corpus0310 import Corpus
import argparse
from experiments0310 import mBERT_zero, mBERT_few
import statistics as stat


parser = argparse.ArgumentParser(description="This module carries out cross-lingual metaphor detection.")
parser.add_argument("-x", "--experiment", type=str, metavar="", required=True, help="zero, few, madx")
...
def md_classification(experiment, file_train, file_test, language):
    file_train = "data/" + file_train
    file_test = "data/" + file_test
    seeds = [2, 42, 63]
