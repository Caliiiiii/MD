...
class TrainerMbert(object):
    def __init__(self, dataframe_train, dataframe_test, target_file, seed):
        ...
        self.input_train = self.dataframe_train[["sent1", "sent2", "label"]]
        self.input_test = self.dataframe_test[["sent1", "sent2", "label"]]
    ...
    def predict(self):
        ...
        self.dataframe_test["predictions"] = preds # preds是预测标签
